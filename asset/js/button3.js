...
"use strict";
  ...
  var el= $('.rm'),
      ...
      Trunc = {
    moreLink: '<a href="#" class="rm-toggle" data-read="MORE">Read More<span class="icon-arrow-bottom"</span></a>',
    lessLink: '<a href="#" class="rm-toggle" data-read="LESS">Read Less<span class="icon-arrow-top"></span></a>',
    addTrigger : function(){
      $('.article-rm').append(this.moreLink); 
    },
